...
@register_model("st_gcn_model")
class st_gcn_model(nn.Module):
    def __init__(self, in_channels=3, hidden_channels=16, hidden_dim=256, num_class=60,
                 edge_importance_weighting=True, graph_layout='ntu-rgb+d', **kwargs):
        super().__init__()
...
class Graph():
    ...
    def get_edge(self, layout):
        if layout == 'openpose':
            ...
            self.num_node = 15
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_1base = [(1, 2), (2, 3), (3, 2), (4, 1), (5, 1),
                              (6, 12), (7, 12), (8, 15), (9, 15), (10, 4),
                              (11, 10), (12, 10), (13, 5), (14, 13), (15, 14),
                             ]
            neighbor_link = [(i - 1, j - 1) for (i, j) in neighbor_1base]
            self.edge = self_link + neighbor_link
            self.center = 1
